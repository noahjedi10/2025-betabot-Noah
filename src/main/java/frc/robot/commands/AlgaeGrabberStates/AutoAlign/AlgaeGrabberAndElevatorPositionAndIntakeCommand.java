...
package frc.robot.commands.AlgaeGrabberStates.AutoAlign;
...
public class AlgaeGrabberAndElevatorPositionAndIntakeCommand extends Command {
  ...
  public AlgaeGrabberAndElevatorPositionAndIntakeCommand(ElevatorSubsystem elevatorSubsystem, AlgaeGrabberSubsystem algaeGrabberSubsystem, double elevatorPosition, double algaeGrabberPosition) {
  ...
  public void initialize() {
    System.out.println("Raising elevator and algae grabber for intake sequence");
  }
