...
public class ElevatorGoToPositionAndEndCommand extends Command {
  ElevatorSubsystem elevatorSubsystem;
  double positionSetpoint;
  public ElevatorGoToPositionAndEndCommand(ElevatorSubsystem elevatorSubsystem, double positionSetpoint) {
