...
public class AutoScoreCommandAuton extends Command {
  ...
  public AutoScoreCommandAuton(DriveSubsystem driveSubsystem, ElevatorSubsystem elevatorSubsystem, double scoringPosition, BooleanSupplier onLeftSide) {
  ...
  public AutoScoreCommandAuton(DriveSubsystem driveSubsystem, ElevatorSubsystem elevatorSubsystem, double scoringPosition, BooleanSupplier onLeftSide, double grabberSpeed) {
    this.driveSubsystem = driveSubsystem;
    this.elevatorSubsystem = elevatorSubsystem;
    this.scoringPosition = scoringPosition;
    this.onLeftSide = onLeftSide;
  ...
  public void end(boolean interrupted) {    
    ...
    Command alignmentCommand = AutoAlignCommandFactory.getAutonomousAutoAlign(
