...
public class CameraConstants {
    ...
    public static final Transform3d LOCALIZATION_CAM_TWO_OFFSET = new Transform3d(new Translation3d(0.29845, -0.2159, 0.1143), new Rotation3d(0, 0, Math.toRadians(45)));
}